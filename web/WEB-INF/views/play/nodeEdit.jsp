            ...
            <div class="container-lg" style="margin-top: 3rem; margin-bottom: 5rem">
                <div class="row mb-3">
                    <div class="col col-lg-6 mx-auto">
                        <h3 class="text-bold text-center">영상 수정하기</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-lg-6 mx-auto">
                        <form action="/play/${listId}/edit/${nodeId}" method="post" onsubmit="return verifyWrite()" autocomplete="off">
                            ...
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-secondary btn-sm mr-2" href="/play/${listId}"><i class="fas fa-arrow-circle-left"></i> 뒤로가기</a>
