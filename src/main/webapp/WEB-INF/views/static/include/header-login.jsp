...
<header>
    <nav class="navbar navbar-expand-lg justify-content-between">
        ...
        <div class="d-none d-lg-flex justify-content-end align-items-center" style="width: 800px">
            <ul class="navbar-nav" data-role="primary">
                <li class="nav-item mr-2">
                    <a class="nav-link" href="/play">플레이</a>
                </li>
                <li class="nav-item mr-2">
                    <a class="nav-link" href="/my">내정보</a>
                </li>
                <li class="nav-item mr-2">
        ...
        <!-- 반응형 네비게이션 -->
        <div class="d-lg-none" id="side" data-role="sidebar">
            ...
            <div class="d-none" id="side-view" data-role="side-view">
                ...
                <ul class="table table-hover mt-5 pt-3" data-role="side">
                    <li class="mt-1">
                        <a class="px-4 py-2" href="/play">플레이</a>
                    </li>
                    <li class="mt-1">
                        <a class="px-4 py-2" href="/my">내정보</a>
                    </li>
                    <li class="mt-1">
                        <a class="px-4 py-2" href="/notice">공지사항</a>
                    </li>
                    <li class="mt-1">
                        <a class="px-4 py-2" href="/logout">로그아웃</a>
                    </li>
                </ul>
            </div>
        </div>
